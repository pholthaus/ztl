...
setup(name='ztl',
      ...
      package_dir={'':'src'},
      packages=['ztl', 'ztl.core', 'ztl.cmd', 'ztl.example'],
      scripts=['src/ztl/example/simple_client.py',
            'src/ztl/example/simple_server.py',
            'src/ztl/example/simple_publisher.py',
            'src/ztl/example/simple_subscriber.py',
      ...
      entry_points={
            'console_scripts': [
                  ...
                  'ztl_simple_publisher=ztl.example.simple_publisher:main_cli',
                  'ztl_simple_subscriber=ztl.example.simple_subscriber:main_cli',
